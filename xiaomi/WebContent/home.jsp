						...
						<ul>
							<%
								...
								if (username == null)
								{
									...
									out.println("<li><a href='./login.jsp' target='_self'>个人中心</a></li>");
								}
								else
								{
									...
									out.println("<li><a href='self_info.jsp'>个人中心</a></li>");
								}
							%>
							<li></li>
						</ul>
...
<!-- start banner_x -->
		<div class="banner_x center">
			...
			<div class="nav fl">
				<ul>
					<li><a href="GoodServlet?operate=findGoodsByName&susu=小米" >小米单品</a></li>
					<li><a href="GoodServlet?operate=findGoodsByName&susu=红米">红米</a></li>
					<li><a href="GoodServlet?operate=findGoodsByName&susu=笔记本">平板·笔记本</a></li>
					<li><a href="GoodServlet?operate=findGoodsByName&susu=电视">电视</a></li>
			...
			<div class="search fr">
				<form action="GoodServlet?operate=findGoodsByName" method="post">
					<div class="text fl">
						<input type="text" class="shuru" name = "susu" placeholder="小米6&nbsp;小米MIX现货">
					</div>
					<div class="submit fl">
			...
			<div class="nav">				
				<ul>
					<li>
						...
						<a href="">电话卡</a>
						<div class="pop">
							<c:forEach items="${shouji}" var="sj">
							<div class="left fl">
									<div class="xuangou_left fl">
										<a href="GoodServlet?operate=xiangqing&goodId=${sj.id}">
											<div class="img fl"><img width="40px" height="40px" src="${sj.image}" alt=""></div>
											<span class="fl">${sj.name}</span>
											<div class="clear"></div>
										</a>
									</div>
									<div class="xuangou_right fr"><a href="GoodServlet?operate=xiangqing&goodId=${sj.id}" target="_blank">选购</a></div>
									<div class="clear"></div>	
							</div>
							</c:forEach>
					...
					<li>
						...
						<div class="pop">
							<div class="left fl">
								<c:forEach items="${bijiben}" var="bjb">
							<div class="left fl">
									<div class="xuangou_left fl">
										<a href="GoodServlet?operate=xiangqing&goodId=${bjb.id}">
											<div class="img fl"><img width="40px" height="40px" src="${bjb.image}" alt=""></div>
											<span class="fl">${bjb.name}</span>
											<div class="clear"></div>
										</a>
									</div>
									<div class="xuangou_right fr"><a href="GoodServlet?operate=xiangqing&goodId=${bjb.id}" target="_blank">选购</a></div>
									<div class="clear"></div>	
							</div>
							</c:forEach>
					...
					<li>
						...
						<div class="pop">
								<div class="left fl">
								<c:forEach items="${dianshi}" var="ds">
							<div class="left fl">
									<div class="xuangou_left fl">
										<a href="GoodServlet?operate=xiangqing&goodId=${ds.id}">
											<div class="img fl"><img width="40px" height="40px" src="${ds.image}" alt=""></div>
											<span class="fl">${ds.name}</span>
											<div class="clear"></div>
										</a>
									</div>
									<div class="xuangou_right fr"><a href="GoodServlet?operate=xiangqing&goodId=${ds.id}" target="_blank">选购</a></div>
									<div class="clear"></div>	
							</div>
							</c:forEach>
